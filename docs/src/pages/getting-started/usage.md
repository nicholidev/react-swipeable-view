...
<p class="description">Get started with react-swipeable-view in no time.</p>
...
import React from 'react';
import SwipeableViews from 'react-swipeable-view';
import { virtualize } from 'react-swipeable-view-utils';
...
import React from 'react';
import SwipeableViews from 'react-swipeable-view';
import { autoPlay } from 'react-swipeable-view-utils';
...
import React from 'react';
import SwipeableViews from 'react-swipeable-view';
import { bindKeyboard } from 'react-swipeable-view-utils';
