...
import SwipeableViews from '../../packages/react-swipeable-view-native/src';
import { virtualize, autoPlay } from 'react-swipeable-view-utils';
import { mod } from 'react-swipeable-view-core';
